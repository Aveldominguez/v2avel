...
export const WIZZ_FIELDS: FieldDefinition[] = [
  ...
  createField('WIZZ', 'BJ', 'Priority', 4),
  createField('WIZZ', 'BR', 'Rush', 5),
  createField('WIZZ', 'DAA', 'Delivery at Aircraft (Carrito)', 6),
  createField('WIZZ', 'CREW', 'Crew', 7),
  createField('WIZZ', 'E', 'Equipment', 8),
  createField('WIZZ', 'BH', 'Grupo (varios tránsitos, mismo destino)', 9),
  createField('WIZZ', 'B-Xr', 'Restos', 10),
  createField('WIZZ', 'WLB', 'Wheelchair – Lithium Battery (Manual Power)', 11),
  createField('WIZZ', 'WCH', 'Wheelchair', 12),
  createField('WIZZ', 'WDB', 'Wheelchair – Dry Battery', 13),
];
