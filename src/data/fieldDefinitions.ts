...
export const WESTJET_FIELDS: FieldDefinition[] = [
  ...
  createField('WESTJET', 'DAA', 'Delivery At Aircraft (Carrito)', 6),
  createField('WESTJET', 'D', 'Crew', 7),
  createField('WESTJET', 'E', 'Equipment', 8),
  createField('WESTJET', 'BH', 'Grupo (varios de tránsito mismo destino)', 9),
  createField('WESTJET', 'WLB', 'Wheelchair – Lithium Battery (Manual Power)', 10),
  createField('WESTJET', 'WCH', 'Wheelchair', 11),
  createField('WESTJET', 'WDB', 'Wheelchair – Dry Battery', 12),
];
